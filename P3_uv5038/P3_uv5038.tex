...
[$s_1, s_2, s_3, s_4, s_5, s_6$]. \citeasnoun{Delaunay1933} represents
...
\begin{figure}
	\begin{center}
		...
		described by  \citeasnoun{Delaunay1933}, but labeled using the vector components of \SVI{} \cite{andrews2023measuring}. Visualized as a
...
\begin{figure}
	...
	\caption{Scatter plots of the same 100 randomly selected primitive triclinic unit cells represented in P3 as  shown in Figure \ref{PlotPolar_raw}, Niggli-reduced.}
	\end{center}
\end{figure}

% Scatter plots of the same 100 randomly selected primitive triclinic unit cells represented in P3 as shown in
%Figure 3, Niggli-reduced”

\begin{figure}
	\begin{center}
	\includegraphics[width=\columnwidth]{PlotPolar_Delone}
	\label{PlotPolar_Delone}
	\caption{Scatter plots of the same 100 randomly selected
		primitive triclinic unit cells represented in \PIII{} as 
		shown in Figure \ref{PlotPolar_raw}, Selling/Delone-reduced.}
	\end{center}
\end{figure}
