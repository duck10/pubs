...
% edited in github to add this line
...
\begin{document}                  % DO NOT DELETE THIS LINE
	...
	\citeasnoun{andrews2019b} chose to represent the scalars in the space \SVI{},
	...
	of each are the ``opposite'' scalars according to the definition of \citeasnoun{Delaunay1932} (see \citeasnoun{andrews2019a}).
	As a memonic device, note that the complex components involve ($\alpha,a$), ($\beta, b$), and ($\gamma,c$).
	
		\citeasnoun{andrews2019b} considered the matrix representations of the reflections in \CIII{} (and in \SVI{}). This paper will describe the boundary transformations at the edges of the fundamental
